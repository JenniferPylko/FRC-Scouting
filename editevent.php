...
<body>
	...
	<article style="padding-top: 40pt; background: #1e208d">
		<form action="event.php" method="POST" style="text-align: left; padding-left: 2%; padding-top: 3%; width: 85%; background: #fff">
			...
			<?php
				...
				{
			?>
			<input type="number" min="1" style="color: red" name="<?php echo(0+6*$i);?>"/>
