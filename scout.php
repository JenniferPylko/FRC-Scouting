...
<body>
	...
	<article>
		...
		{
			echo("Error: Event $evt match $matchno doesn't have a lineup.");
		}
			...
			<table>
				...
				<tr><td><table class="subtable">
					...
					<td><table class="subsubtable">
						...
						<tr><td><input type="checkbox" name="pl"/></td><td><input type="checkbox" name="pul"/></td><td><input type="checkbox" name="plib"/></td><td><input type="checkbox" name="hpplib"/></td></tr>
					</td></table></tr>
				</table></td></tr>
				<tr><td><table class="subtable">
					...
					<tr><td><table class="subsubtable">
						...
						<tr><td><input type="number" name="fouls" value="0"/></td><td><input type="number" name="tfouls" value="0"/></td></tr>
					</table></td>
					<td><table class="subsubtable">
						<tr><th>From Center</th><th>From Station</th></tr>
						<tr><td><input type="number" name="tfc" value="0"/></td><td><input type="number" name="tfs" value="0"/></td></tr>
					</table></td></tr>
				</table></td></tr>
				<tr><td><table class="subtable">
					...
					<tr><td><table class="subsubtable">
						...
						<tr><td><input type="checkbox" name="cft"/></td><td><input type="checkbox" name="ctp"/></td><td><input type="checkbox" name="cssc"/></td><td>1<input type="radio" name="pos" value="1"/> 2<input type="radio" name="pos" value="2"/> 3<input type="radio" name="pos" value="2"/></td></tr>
					</table></td></tr>
				</table></td></tr>
